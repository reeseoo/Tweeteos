    ...
    showPanel(panelVisible){
        if(panelVisible){
            return <div style={{width: "200px", height: "100%", backgroundColor: "#ffffff", position: "absolute", top: "0"}}>
                <input type="text" value={this.props.input} onChange={this.props.handleChange.bind(this)} onKeyUp={this.props.changeSubject(this.props.socket).bind(this)} style={{marginTop: "60"}}></input>
            </div>
        }else{
